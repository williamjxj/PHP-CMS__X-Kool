(function(jQuery) {
    ...
    jQuery.fn.stickyNotes.createNoteBackground = function() {
        ...
        if (jQuery.browser.msie && jQuery.browser.version <= 6)  {
            background = $(document.createElement('div')).addClass("background").html('<img src="include/jquery-sticky-notes/images/spacer.gif" class="stretch" style="margin-top:2px;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'include/jquery-sticky-notes/images/sticky-bg.png\',sizingMethod=\'scale\'");" alt="" />');
        } else {
            background = $(document.createElement('div')).addClass("background").html('<img src="include/jquery-sticky-notes/images/sticky-bg.png" class="stretch" style="margin-top:5px;" alt="" />');
        }
        return background;
